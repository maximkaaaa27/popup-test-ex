...
### Переход по вьюшкам с помощью React-redux, также как и управление воспроизведением и навигацией с клавиатуры

### Подробнее о навигации. Сверху, в контексте сетка из массивов. Навигация осуществляется по макету Array[X][Y]

### Валидация номера numverify с использованием verify.hook 
